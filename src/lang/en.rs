...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_start_service_tip", "Start the service or enable Screen Capture to begin sharing your screen."),
        ...
        ("empty_chat_tip", "No active conversations yet.\nStart or accept a session to chat."),
